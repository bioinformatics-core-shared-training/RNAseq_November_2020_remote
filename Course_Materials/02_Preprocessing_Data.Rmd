...
dim(countdata)
# for each gene, compute total number of counts and compare to threshold
...
statusCol <- match(sampleinfo$Status, c("virgin", "pregnant", "lactate")) + 1 # '+1' to avoid color '1' i.e. black
...
really far above or below the blue horizontal (overall median) line we may need to investigate
that sample further.
...
The `vst` function computes the fitted dispersion-mean relations and accounts for library size.
