...
>     - Test terms in the "Molecular Function" ontology 
...
>     - For this analysis you can use Ensembl IDs rather then Entrez - you'll
> need to set the `keyType` parameter in the `enrichGO` command.
